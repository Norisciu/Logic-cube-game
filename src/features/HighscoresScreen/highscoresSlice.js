...
export const scoreEntryAlreadyInList = (score, scoreList) => scoreList.find(elem => equalScoreEntries(elem, score));
export const equalScoreEntries = (score, other) => score && other && score.score === other.score && score.userName === other.userName;
export const entriesSort = (entries) => entries.sort((entry , other) => compareEntries(entry , other));
export const compareEntries =   (entry , other) => (entry.score - other.score) || (entry.userName.localeCompare(other.userName)); 
